...
const Map<String, String> en = {
  ...
  'analyze_density': 'Analyze Density',
  ...
  'menu_magic': 'Magic Experience',
  'menu_impact': 'My Impact',
  'menu_settings': 'SETTINGS',

  // Admin Dashboard
  'seed_data': 'Seed Data',
  'geospatial_viz': 'Geospatial Data Visualization',
  'density': 'DENSITY',
  'low': 'Low',
  'high': 'High',
  'dispatch_response': 'Dispatch Immediate Response',
  'cases': 'Cases',
  'recovered': 'Recovered',
  ...
  'home': 'Home',
  'alerts': 'Alerts',
  'select_details': 'Select an item to see details',
  'exit_app_title': 'Exit App?',
  'exit_app_message': 'Are you sure you want to exit the application?',
  'exit': 'Exit',
  'weekend_message':
      'Enjoy your weekend! 🌞\nThe system will be back Monday at 8 AM.',
  'morning_wait_message':
      'Good morning! Today\'s visits will be assigned by 9 AM.\n☕ Grab a tea while you wait.',
  'afternoon_caught_up_message':
      'All caught up for today! 🎉\nYour supervisor will assign tomorrow\'s visits by evening.',
  'evening_good_work_message':
      'Great work today! Check back tomorrow morning for new assignments.',
  'route_optimized': 'Route optimized by nearest visit',
  ...
  'assigned': 'Assigned',
  'no_tasks_msg': 'No tasks assigned yet.\nEnjoy your free time!',
  'optimize_route': 'Optimize Route',

  // Seeding
  'seeding_csv_msg': '🌱 Seeding CSV data... This may take a while.',
  'csv_seeded_msg': '✅ CSV Data Seeded!',
  'test_data_seeded_msg': '✅ Test data seeded successfully!',
  'error_seeding_msg': '❌ Error seeding data',
  'dispatch_alert_msg': 'Dispatching emergency team to',
  ...
  'tap_to_explore': 'Tap to explore real-time data',
  ...
  'cough_analysis': 'AI Audio Cough Analysis',
  'capture_photo': 'Capture Photo',
  'analyze_image': 'Analyze Image',
  'record_cough': 'Record Cough',
  'recording': 'Recording...',
  'analyzing_audio': 'Analyzing audio patterns...',
  'vision_result': 'Vision Analysis Result',
  'cough_result': 'Cough Pattern Result',

  // Blood Donation
  'blood_donation': 'Blood & Organ Donation',
  'donor_registration': 'Register as Donor',
  'blood_requests': 'Active Blood Requests',
  ...
  // Medical Responses
  'heart_attack':
      '⚠️ CRITICAL: Chest pain or suspected heart attack is a medical emergency.\n\nPlease call 108 (Ambulance) immediately or go to the nearest emergency room.\nSymptoms include: chest pressure, pain spreading to arm/jaw, shortness of breath, cold sweat.',
  'stroke':
  ...
  'choking':
      '⚠️ CRITICAL: If someone is choking, perform the Heimlich maneuver if trained, or call 108 immediately.',
  'burn':
      'For minor burns, run cool water (not ice) over the area for 10-15 minutes.\nFor severe burns, do not remove stuck clothing. Cover loosely with a clean cloth and seek emergency help.',
  'poison':
      '⚠️ If someone swallowed poison, identify the substance and call emergency services or the National Poisons Information Centre (1800-116-117) immediately.',
  'headache':
      'Headaches are common and can be caused by dehydration, stress, or eye strain.\n\n• Drink plenty of water.\n• Rest in a quiet, dark room.\n• Use over-the-counter pain relief if needed.\n\nIf the headache is sudden and severe (\'worst headache of your life\') or accompanied by confusion, seek help immediately.',
  'fever':
      'A fever is usually a sign your body is fighting an infection.\n\n• Stay hydrated.\n• Rest adequately.\n• You can take Paracetamol consistent with dosage instructions.\n\nSeek help if fever exceeds 103°F (39.4°C) or lasts more than 3 days.',
  'cough':
      'Coughs are often caused by viral infections like the cold or flu.\n\n• Stay hydrated with warm fluids.\n• Gargle with warm salt water.\n• Use honey or cough drops for relief.\n\nConsult a doctor if you cough up blood or have difficulty breathing.',
  'cold':
      'Common cold symptoms usually resolve in 7-10 days.\n\n• Rest and hydration are key.\n• Steam inhalation can help with congestion.\n• Monitor for fever.',
  'stomach':
  ...
  'malaria':
      'Malaria is caused by parasites transmitted by mosquito bites.\n\nSymptoms: Fever, shaking chills, sweating, headache, and nausea.\nLeft untreated, it can be severe. A blood test is fast and effective for diagnosis at SMC clinics.',
  'covid':
  ...
  'hair_loss':
      'Hair loss can be due to stress, diet, or genetics.\nEnsure protein-rich diet. Consult a dermatologist if loss is sudden or patchy.',
  'diet':
      'A balanced diet includes fruits, vegetables, whole grains, and protein.\n\n• Drink 8 glasses of water daily.\n• Limit processed foods and sugar.\n• Eat at regular intervals.',
  'sleep':
  ...
  'iot_connected': 'All Systems Connected',
  'iot_last_ping': 'Last ping: 2s ago',
  'iot_total_devices': 'Total Devices',
  'iot_online': 'Online',
  'iot_alerts_active': 'Active Alerts',
  'iot_low_battery': 'Low Battery',
  'iot_my_devices': 'My Devices',
  ...
  'iot_air_quality_label': 'Air Quality',
  'iot_noise_level': 'Noise Level',
  'iot_live_feed': 'Live Sensor Feed',
  'iot_device_status': 'Device Status',
  'iot_active': 'Active & Reporting',
